        ...
        <div class="main-content horizontal-content">
            ...
            <div class="container">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            <h4 class="content-title mb-0 my-auto">Contact Us</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bg-primary-gradient text-center mb-4 h3 text-white p-4">
                                    <i class="fa fa-phone-square" aria-hidden="true"></i>
                                    +94 77 22 55 356
                                </div>

                                <div class="bg-danger-gradient text-center mb-4 h3 text-white p-4">
                                    <i class="fa fa-envelope" aria-hidden="true"></i>
                                    infor@gmail.com
                                </div>

                                <div class="bg-warning-gradient text-center mb-4 h3 text-white p-4">
                                    <i class="fa fa-map-marker" aria-hidden="true"></i>
                                    Colombo
                                </div>


                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126743.58585959197!2d79.7861641537226!3d6.922003946861952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae253d10f7a7003%3A0x320b2e4d32d3838d!2sColombo!5e0!3m2!1sen!2slk!4v1653116390567!5m2!1sen!2slk" width="100%" height="355" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
